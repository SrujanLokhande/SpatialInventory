...
#include "Components/AssetManager_Custom.h"
...
UAssetManager_Custom* UAssetManager_Custom::ForceLoadItem(const FPrimaryAssetId& PrimaryAssetId, bool bLogWarning) const
{
