 ...
 */
UCLASS()
class RESIDENTINVENTORY_API UInventoryFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Inventory")
	static bool DoesItemHaveValidEquipmentSlot(const UItemDataStruct* Item);
